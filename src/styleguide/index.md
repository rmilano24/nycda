...
<p class="lead">Below you can find the different values we created that support the primary color variable you can change at any time in <code>\variables.scss</code></p>
...
<div class="row up-1 medium-up-3 large-up-5">
  <div class="column">
    <div class="color-block">
      <span style="background: #FFCB04"></span>
      #FFCB04
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #1A1919"></span>
      #1A1919
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #2D2C2C"></span>
      #2D2C2C
    </div>
  </div>
  <div class="column">
...
<p class="lead">This design uses DIN Next W01 Bold for headings and DIN Next W01 Regular paragraph text.</p>
